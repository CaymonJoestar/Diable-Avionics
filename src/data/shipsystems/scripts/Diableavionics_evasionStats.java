...
public class Diableavionics_evasionStats extends BaseShipSystemScript {
    ...
    public void apply(MutableShipStatsAPI stats, String id, State state, float effectLevel) {        
        stats.getMaxSpeed().modifyFlat(id, 8000f*effectLevel);
        stats.getAcceleration().modifyPercent(id, 2500f * effectLevel);
        stats.getDeceleration().modifyPercent(id, 2500f * effectLevel);
